...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Buat Purchase Order</h2>
            <p class="text-sm text-gray-500">Buat pesanan pembelian baru untuk stok inventaris.</p>
        </div>
        <nav>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <textarea name="notes" rows="4" placeholder="Contoh: Lampirkan invoice, barang fragile..."
                        class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white leading-relaxed"></textarea>
                </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ route('purchase-orders.index') }}" class="text-center text-xs font-medium text-gray-500 hover:text-error-500 transition">Batalkan dan Kembali</a>
                    </div>
                </div>
            </div>
        </div>
