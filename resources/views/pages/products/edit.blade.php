    ...
    <div class="mx-auto max-w-(--breakpoint-2xl) px-4 md:px-6 2xl:px-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Perbarui data produk <span class="font-bold text-brand-500">{{ $product->name }}</span> ke sistem Mesama ERP.</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03] lg:p-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="name" placeholder="Contoh: Acne Care Night Cream 30g" value="{{ old('name', $product->name) }}" required
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="sku" placeholder="MSM-SK-001" value="{{ old('sku', $product->sku) }}" required
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4" placeholder="Jelaskan manfaat, kandungan, atau cara penggunaan produk..."
                                    class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">{{ old('description', $product->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="purchase_price" placeholder="0" value="{{ old('purchase_price', $product->purchase_price) }}" required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-bold text-gray-400">Rp</span>
                                    <input type="number" name="selling_price" placeholder="0" value="{{ old('selling_price', $product->selling_price) }}" required
                            ...
                            <div>
                                <label class="mb-2.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Stok Saat Ini</label>
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <div x-data="{ photoName: null, photoPreview: '{{ $product->image ? asset('storage/' . $product->image) : null }}' }" class="space-y-4">
                            <!-- Hidden File Input -->
                            ...
                            <div class="relative h-48 w-full rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/50 transition hover:border-brand-500"
                                ...
                                <div x-show="! photoPreview" class="flex flex-col items-center justify-center h-full text-center p-4">
                                    ...
                                    <p class="text-xs font-medium text-gray-500">Klik untuk ganti foto</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <div class="relative z-20">
                            <select name="unit" required
                                ...
                                <option value="Pot" {{ old('unit', $product->unit) == 'Pot' ? 'selected' : '' }}>Pot</option>
