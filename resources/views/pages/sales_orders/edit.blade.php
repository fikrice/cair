...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Sales Order</h2>
            <p class="text-sm text-gray-500 font-mono font-bold">{{ $salesOrder->so_number }}</p>
        </div>
        <nav>
    ...
    <form action="{{ route('sales-orders.update', $salesOrder) }}" method="POST" x-data="soForm()">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-5">
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" value="{{ $salesOrder->so_number }}" readonly
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="customer_name" value="{{ $salesOrder->customer_name }}" required placeholder="Masukkan nama pelanggan..."
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="date" name="so_date" value="{{ $salesOrder->so_date->format('Y-m-d') }}" required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="customer_phone" value="{{ $salesOrder->customer_phone }}" placeholder="0812..."
                                        class="w-full rounded-lg border border-gray-300 bg-transparent pl-11 pr-4 py-3 text-sm outline-hidden focus:border-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                                </div>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <textarea name="shipping_address" rows="3" placeholder="Jl. Contoh No. 123, Jakarta..."
                        class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">{{ $salesOrder->shipping_address }}</textarea>
                </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ route('sales-orders.show', $salesOrder) }}" class="text-center text-xs font-medium text-gray-500 hover:text-error-500 transition">Batalkan</a>
                    </div>
                </div>
            </div>
        </div>
