...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Supplier</h2>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
            ...
            <div class="xl:col-span-2 space-y-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <p class="mt-0.5 text-sm text-gray-500">Detail identitas perusahaan supplier.</p>
                    </div>
                    <div class="p-6 space-y-5">
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-400">Kode Supplier <span class="text-error-500">*</span></label>
                                <input type="text" name="code" value="{{ old('code', $generatedCode) }}" required readonly
                            ...
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-400">Status <span class="text-error-500">*</span></label>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: PT Bahan Baku Nusantara" required
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="contact_person" value="{{ old('contact_person') }}" placeholder="Nama penanggung jawab"
                                    class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                            </div>
                            <div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <textarea name="address" rows="3" placeholder="Jl. Industri No. 123, Kawasan Industri Pulogadung..."
                                class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">{{ old('address') }}</textarea>
                        </div>
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-400">Kota</label>
                            <input type="text" name="city" value="{{ old('city') }}" placeholder="Contoh: Jakarta Timur"
                                class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" placeholder="0812-3456-7890"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" placeholder="supplier@mail.com"
                                    class="w-full rounded-lg border border-gray-300 bg-transparent py-3 pl-11 pr-4 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                            </div>
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <textarea name="notes" rows="3" placeholder="Catatan tambahan tentang supplier ini..."
                        class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-hidden transition focus:border-brand-500 focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white">{{ old('notes') }}</textarea>
                </div>
